...
const Util = {
  ...
  getPost: async () => {
    const URL = `http://localhost:8000/post?token=${localStorage.getItem("token")}`;
    const response = await fetch(URL, {
      method: "GET",
      mode: "cors",
    });
  ...
  editPost: async (
    ...
    const URL = `http://localhost:8000/post?id=${_id}&token=${localStorage.getItem("token")}`;
    const response = await fetch(URL, {
      method: "PUT",
      mode: "cors",
      cache: "no-cache",
  ...
  deletePost: async (postID) => {
    const URL = `http://localhost:8000/post?id=${postID}&token=${localStorage.getItem("token")}`;
    const response = await fetch(URL, {
      method: "delete",
      mode: "cors",
    });
  ...
  getComment: async (postID) => {
    const URL = `http://localhost:8000/comment?post_id=${postID}&token=${localStorage.getItem("token")}`;
    const response = await fetch(URL, {
      method: "GET",
      mode: "cors",
    });
